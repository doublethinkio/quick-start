...
[**The commit hash for the last trace: 71eb9f2b7778e4fe04692702a724254c98376e42**](https://github.com/electron-react-boilerplate/electron-react-boilerplate/commit/71eb9f2b7778e4fe04692702a724254c98376e42)

How does it different from master repository ?

- The state management library Redux is changed to easy-peasy
- Unit test library changes to @testing-library/react
- The code specifications have also changed(no semi)
- CSS Module to CSS in JS (Emotion + Rebass), but css module is still available

Make the code as concise and easy to understand as possible

- easy-peasy(No redux verbose code)
- @testing-library/react(Easy to test)
- no semi (Why keep it if you can do without it?)
- CSS in JS(just javascript)
